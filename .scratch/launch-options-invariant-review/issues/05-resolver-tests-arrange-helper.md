...
## Comments
- Helper privado `CreateResolver(CfxService)` centraliza `new ServerResolver(cfxService, new ServerRequirementsResolver())`; se reemplazaron las 9 ocurrencias inline.