...
- [x] `AGENTS.md` refleja `ToCommandLineArgs(): ImmutableArray<string>` y el conteo real de tests (63)
...
- [x] La suite completa sigue verde en el punto commiteado (63)
...
- Fase commiteada en 5c4b77f + 03c68d4. Suite 63 verde en el punto commiteado.